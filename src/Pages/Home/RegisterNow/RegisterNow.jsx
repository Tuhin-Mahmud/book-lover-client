                    ...
                    <form onSubmit={handleSubmit} className="card-body">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                            ...
                            <div className="form-control w-full">
                                ...
                                <input
                                    name="lastName"
                                    type="text" placeholder="Last " className="input input-bordered " required />
                            ...
                            <div className="form-control w-full">
                                ...
                                <input
                                    name="email"
                                    type="email" placeholder="example@gmail.com" className="input input-bordered " required />
                            ...
                            <div className="form-control w-full">
                                ...
                                <input
                                    name="phone"
                                    type="number" placeholder="phone number" className="input input-bordered " required />

                            </div>
                        </div>
                        <div className="form-control w-full">
                            <label className="label">
                                <span className="label-text">What&apos;s your availability date:*</span>
                            </label>
                            <input
                                name="date"
                        ...
                        <div>
                            <label className="label">
                                <span className="label-text">please share your farming experience*</span>
                            </label>
                            <textarea name="text" className="textarea textarea-bordered w-full h-[150px]" placeholder="Write Message"></textarea>
                        </div>
                        <div className="form-control mt-6">
                            {/* <button className="btn btn-primary">Login</button> */}
                            <input type="submit" value="Send Message" className='btn bg-[#052c65] text-white hover:text-black' />
                        </div>
                    </form>
                </div>
            </div>
