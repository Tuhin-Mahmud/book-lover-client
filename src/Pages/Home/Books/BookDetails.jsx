        ...
        <Container>
            ...
            <div>
                ...
                <div className='flex  my-8'>
                    ...
                    <img className='w-1/3 h-[500px] my-10 ' src={image} alt="" />
                        ...
                        <div className='mt-5'>
                            ...
                            <div className='flex ' >
                                <div className=''>
                                    ...
                                    <button className='hover:text-orange-400 text-xl text-gray-500'>sm</button>
                                    <button className='mx-5 text-xl text-gray-500 hover:text-orange-400'>md</button>
                                    <button className='hover:text-orange-400 text-xl text-gray-500'>xl</button>
                                </div>
                                <div className='mx-8'>
