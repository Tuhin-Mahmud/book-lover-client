            ...
            <div className="max-w-7xl h-[400px]">
                <div className="bg-[#052c65] relative rounded py-32 text-white">
                    ...
                    <div className=" flex flex-col justify-center items-center ">
                        ...
                        <h1 className="text-xl md:text-4xl font-mono font-bold  "> Get 25% Discount in All <br /> Kind Of Super Selling</h1>
                        <Link to={'/shopping'} >
                    ...
                    <img src={disCountImg} alt="" className="w-[400px] h-[450px]  absolute right-0 object-cover bottom-0" />
                </div>
            </div>
        </Container>
    );
