import banner1 from '../../../assets/images/banner/banner1.jpg.jpg'
import banner2 from '../../../assets/images/banner/banner2.jpg.jpg'
import banner3 from '../../../assets/images/banner/banner3.jpg.jpg'
            ...
            <Container>
                <div className="carousel w-full overflow-hidden h-[350px]  md:h-[500px] ">
                    ...
                    <div id="slide1" className="carousel-item relative w-full ">
                        <img src={banner1} className="md:w-full rounded-lg md:h-[500px] object-cover" />
